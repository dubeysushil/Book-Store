...
StripeCheckout.require.define({
    "outer/controllers/app": function(exports, require, module) {
        (function() {
            var App, Checkout, RPC, TokenCallback, keymode, optionParser, tracker, utils, bind = function(fn, me) {
                return function() {
                    return fn.apply(me, arguments)
                }
            };
        ...
        (function() {
            ...
            Checkout = function() {
                ...
                Checkout.prototype.createView = function() {
                    ...
                    path = "/v3/JdhudoUwvSFS85kPDZEQ.html?distinct_id=" + tracker.getDistinctID();
                ...
                Checkout.prototype.open = function(options) {
                    ...
                    iframeFallback = function(_this) {
                        return function() {
                            ...
                            _this.view = new IframeView(_this.onToken, _this.host, "/v3/JdhudoUwvSFS85kPDZEQ.html");
